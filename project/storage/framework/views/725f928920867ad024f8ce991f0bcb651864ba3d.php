...
<body>
    ...
    <div class="container">
      <div class="col-sm-12">
        ...
        <p class="pull-right pay-options">
          <img src="<?php echo e(asset('assets/dest/images/pay/master.png')); ?>">
          <img src="<?php echo e(asset('assets/dest/images/pay/visa.png')); ?>">
          <img src="<?php echo e(asset('assets/dest/images/pay/paypal.png')); ?>">
        </p>
      </div>
    </div><!-- .container -->
  </div><!-- .copyright -->
  ...
  <script src="<?php echo e(asset('js\theme.js')); ?>"></script>
</body>
