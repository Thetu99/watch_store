    ...
    <div class="header-body">
      <div class="container beta-relative">
        ...
        <div class="pull-right beta-components space-left ov">
          ...
          <div class="beta-comp">
            <div class="cart">
              <a href="<?php echo e(url('cart')); ?>"><i class="fa fa-shopping-cart"></i>Giỏ hàng (Trống)</a>
  ...
  <div class="copyright">
    <div class="container">
      ...
      <p class="pull-right pay-options">
        <a href="#"><img src="<?php echo e(asset('assets/dest/images/pay/master.png')); ?>" alt="" /></a>
        <a href="#"><img src="<?php echo e(asset('assets/dest/images/pay/visa.png')); ?>" alt="" /></a>
        <a href="#"><img src="<?php echo e(asset('assets/dest/images/pay/paypal.png')); ?>" alt="" /></a>
      </p>
      <div class="clearfix"></div>
    </div>
    <!-- .container -->
...
</html><?php /**PATH C:\xampp\htdocs\watch_store\resources\views/layouts/theme.blade.php ENDPATH**/ ?>