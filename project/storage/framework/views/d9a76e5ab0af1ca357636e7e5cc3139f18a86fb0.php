...
<div class="container">
  <div id="content">
    ...
    <div class="table-responsive">
          ...
          <tbody>
            ...
            <tr class="cart_item">
              ...
              <td class="product-quantity">
                <span class="amount"><input type="number" min="1" name="qty[<?php echo e($row->rowId); ?>]" value="<?php echo e($row->qty); ?>"
              ...
              <td class="product-remove">
                <a href="<?php echo e(route('cart.remove', $row->rowId)); ?>" class="remove" title="Remove this item"><i
      ...
      <a href="<?php echo e(url('/')); ?>" class="beta-btn primary" name="proceed">Tiếp tục mua hàng <i
      ...
      <div class="cart-totals pull-right">
        ...
        <div class="cart-totals-row">
          ...
          <a href="<?php echo e(url('checkout')); ?>" class="beta-btn primary">Mua hàng</a>
        </div>
      </div>
      </td>
      </tr>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\watch_store\resources\views/theme/cart.blade.php ENDPATH**/ ?>