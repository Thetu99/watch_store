        ...
        <table class="table table-striped table-checkall">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><textarea cols="10" rows="5"><?php echo e($p->name); ?></textarea></td>
              <td><?php echo e($p->brand); ?></td>
              <td><textarea cols="20" rows="5"><?php echo e($p->content); ?></textarea></td>
              <td><?php echo e(number_format($p->price,0,'','.')); ?>đ</td>
              <td><img src="<?php echo e(asset("image/product/$p->thumbnail")); ?>" width="50px" /></td>
              <td><?php echo e(date("G:i j-n-Y", strtotime($p->created_at))); ?></td>
              <td><?php echo e(date("G:i j-n-Y", strtotime($p->updated_at))); ?></td>
              <td>
                <a href="<?php echo e(route('edit_product', $p->id)); ?>" class="btn btn-success btn-sm rounded-0 text-white" type="button" data-toggle="tooltip"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\watch_store\resources\views/admin/product/list.blade.php ENDPATH**/ ?>