...
<body>
  <div id="warpper" class="nav-fixed">
    <nav class="topnav shadow navbar-light bg-warning d-flex">
      <div class="navbar-brand"><a href="<?php echo e(url('admin')); ?>">WATCH STORE ADMIN</a></div>
      <div class="nav-right ">
...
</html><?php /**PATH C:\xampp\htdocs\watch_store\resources\views/layouts/admin.blade.php ENDPATH**/ ?>