              ...
              <div class="col-sm-3">
                <div class="single-item">
                  <div class="single-item-header">
                    <a href="<?php echo e(url("product/$p->id")); ?>"><img src="<?php echo e(asset("image/product/$p->thumbnail")); ?>"
                        alt="" /></a>
                  </div>
                  <div class="single-item-body">
                    <p class="single-item-title"><?php echo e($p->name); ?></p>
                    <p class="single-item-price">
                      <span><?php echo e(number_format($p->price, 0, '', '.')); ?>đ</span>
                    </p>
                  </div>
                  <div class="single-item-caption">
                    <a class="add-to-cart pull-left" href="<?php echo e(route('cart.add', $p->id)); ?>"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <div class="single-item">
                  ...
                  <div class="single-item-body">
                    <p class="single-item-title"><?php echo e($r->name); ?></p>
                    <p class="single-item-price">
                      <span><?php echo e(number_format($r->price, 0, '', '.')); ?>đ</span>
                    </p>
                  </div>
                  <div class="single-item-caption">
                    <a class="add-to-cart pull-left" href="<?php echo e(url('cart')); ?>"><i class="fa fa-shopping-cart"></i></a>
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\watch_store\resources\views/theme/home.blade.php ENDPATH**/ ?>