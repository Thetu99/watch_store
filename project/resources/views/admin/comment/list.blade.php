      ...
      <table class="table table-striped table-checkall">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{route('order.detail', $c->id)}}" class="btn btn-success btn-sm rounded-0 text-white"
...
<td>{{date("G:i j-n-Y", strtotime($c->created_at))}}</td>
<td>
  <a href="{{route('order.detail', $c->id)}}" class="btn btn-success btn-sm rounded-0 text-white" type="button"
    data-toggle="tooltip" data-placement="top" title="Chi tiết">
    <i class="fa fa-file-alt"></i>
  </a>

  <a href="{{route('order.delete', $c->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"
    class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top"
    title="Xóa">
    <i class="fa fa-trash"></i>
  </a>
</td>
