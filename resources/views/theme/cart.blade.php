  ...
  <div id="content">
        ...
        <tfoot>
          <tr>
            <td colspan="6" class="actions">
              ...
              <button type="submit" class="beta-btn primary" name="update_cart">Cập nhật giỏ hàng <i
                  class="fa fa-chevron-right"></i></button>
              <button type="submit" class="beta-btn primary" name="proceed">Tiếp tục mua hàng <i
                  class="fa fa-chevron-right"></i></button>
    ...
    {{-- <form class="shipping_calculator pull-left" action="#" method="post">
        ...
        <section class="shipping-calculator-form " style="display: none;">
          ...
          <p class="form-row form-row-wide">
            <input type="text" class="input-text" value="" placeholder="Postcode / Zip" name="calc_shipping_postcode"
